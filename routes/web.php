...
{
    if (str_contains($html, 'data-xboard-auth-layout-patch')) {
        return $html;
    }
...
<style data-xboard-auth-layout-patch="1">
  ...
  html[data-amg-active="light"] body.amg-theme{background:var(--xboard-liquid-bg)!important;background-attachment:fixed!important}
  ...
  body.xboard-auth-page .xboard-auth-card{box-sizing:border-box!important;width:min(440px,calc(100vw - 32px))!important;max-width:min(440px,calc(100vw - 32px))!important;margin:auto!important;padding:34px 34px 24px!important;border:1px solid var(--login-border)!important;border-radius:18px!important;background:var(--login-card-bg)!important;box-shadow:0 24px 70px rgba(15,23,42,.14)!important;overflow:hidden!important;backdrop-filter:blur(12px)!important}
  html.dark body.xboard-auth-page .xboard-auth-card{box-shadow:0 28px 80px rgba(0,0,0,.38)!important}
  ...
  .xboard-notice-cover{display:block;width:100%;height:clamp(150px,22vw,220px);object-fit:cover;border-radius:14px;border:1px solid rgba(126,147,176,.20);background:rgba(255,255,255,.58);margin:0 0 14px;box-shadow:0 12px 28px rgba(31,56,88,.08)}
  .xboard-notice-cover-wrap{overflow:hidden}
  html.dark .xboard-notice-cover{border-color:rgba(148,163,184,.24);background:rgba(15,23,42,.42);box-shadow:0 14px 34px rgba(0,0,0,.28)}
