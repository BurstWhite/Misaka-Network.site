...
const zh = {
  nav: { dashboard: '仪表盘', subscription: '我的订阅', plans: '购买订阅', orders: '我的订单', invite: '我的邀请', tickets: '我的工单', traffic: '流量明细', docs: '使用文档', servers: '节点状态', profile: '个人中心', gifts: '优惠券' },
...
const en = {
  nav: { dashboard: 'Dashboard', subscription: 'Subscription', plans: 'Buy a plan', orders: 'Orders', invite: 'Invites', tickets: 'Tickets', traffic: 'Traffic', docs: 'Guides', servers: 'Servers', profile: 'Account', gifts: 'Coupons' },
