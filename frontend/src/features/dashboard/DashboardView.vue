...
function openNotice(notice: any) { selectedNotice.value = notice }
...
<template>
  <div class="dashboard-view">
    ...
    <div v-if="selectedNotice" class="modal-backdrop notice-modal-backdrop" role="presentation" @click.self="closeNotice" @keydown.esc="closeNotice">
