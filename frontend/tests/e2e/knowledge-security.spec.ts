    ...
    const data = path.endsWith('/user/knowledge/fetch')
      ? {
          安全: [{
            ...
            body: '<script>window.__knowledgeXss=1</script><svg onload="window.__knowledgeXss=2"></svg><a href="javascript:window.__knowledgeXss=3" onclick="window.__knowledgeXss=4">链接</a><strong>正常内容</strong>',
          }],
        }
